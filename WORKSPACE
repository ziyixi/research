...
go_repository(
    ...
    sum = "h1:NPANcAofwwSuC6SIMwlgmHry2V3pLrSqRiSBKYbNHHA=",
    version = "v0.23.5",
)
...
go_repository(
    ...
    sum = "h1:hH4PQfOndHDlpzYfLAAfl63E8Le6F2+EL/cdhlkyRJY=",
    version = "v0.0.0-20231106173351-e73c9f7bad43",
)
...
go_repository(
    ...
    sum = "h1:/rhkzsAqGQkozwfKS5aFAbb6TyKd3zyFRWcdRXLPCAU=",
    version = "v2.14.0",
)
...
go_repository(
    ...
    sum = "h1:kUmCXUIwJouD7I7ev3OmxzzQVICyhIWAxaXk2yblCMY=",
    version = "v0.17.0",
)
...
go_repository(
    ...
    sum = "h1:K6ol8rfrRkUOefooBC8elXoaNGYkpp7y2qcxGG6BzUE=",
    version = "v1.2.0",
)
...
go_repository(
    ...
    sum = "h1:04VXMiE50YYfCfLboJCLcgqF5x+rHJnb1ssNmqpLH/k=",
    version = "v1.6.0",
)
...
go_repository(
    ...
    sum = "h1:eBH6LSjtX4md5ImDCX8hNhHQvaRf22zujiERoQpsvLo=",
    version = "v1.29.0",
)
...
go_repository(
    name = "com_github_ziyixi_go_ticktick",
    importpath = "github.com/ziyixi/go-ticktick",
    sum = "h1:BKWNRIixlPPM4dbdFEvex7Ok5r++GSvy59JnvBuN4og=",
    version = "v0.0.0-20240413075309-9dcf86a64723",
)
...
go_repository(
    ...
    sum = "h1:+pMtLEV2k0AXKvs/tGZojuj6QaioxfUjOpMsG5Gtx+w=",
    version = "v0.9.1",
)
